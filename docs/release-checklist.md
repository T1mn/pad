...
4. Confirm the bundle contains `app.asar`, Pi and the utility-process host, but no standalone Node.js, Bun or `Contents/Resources/pad`; locale directories are limited to English, Simplified Chinese, and Traditional Chinese.
