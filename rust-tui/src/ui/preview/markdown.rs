...
pub(crate) mod tests {
    pub(crate) mod inline {
        ...
        pub(crate) fn format_line_detects_error_case_insensitively() {
        ...
        pub(crate) fn format_line_detects_success_case_insensitively() {
            let theme = Theme::default();
    ...
    pub(crate) mod normalize {
        ...
        pub(crate) fn inserts_paragraph_gaps_between_plain_lines() {
            assert_eq!(
        ...
        pub(crate) fn keeps_fenced_code_lines_together() {
            assert_eq!(
