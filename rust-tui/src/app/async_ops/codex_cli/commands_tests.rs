...
pub(crate) fn parse_codex_version_from_cli_output() {
    assert_eq!(
...
pub(crate) fn parse_npm_version_json_output() {
    assert_eq!(
...
#[cfg(unix)]
pub(crate) fn update_uses_detected_codex_binary_native_command() {
