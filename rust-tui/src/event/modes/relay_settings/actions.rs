                    ...
                    if let Some(provider) = agent.providers.get(app.relay_selected_provider) {
                        app.relay_edit_buffer = match agent.name.as_str() {
                            ...
                            _ => match app.relay_edit_field {
                                ...
                                3 if agent.name == "claude" => {
                                    provider.disable_thinking.to_string()
                                }
                                _ => String::new(),
                            },
                        };
...
pub(super) use agent_list::handle_agent_list_key;
pub(super) use detail_pane::handle_detail_pane_key;
pub(super) use provider_list::handle_provider_list_key;
