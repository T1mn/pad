...
- `agent_launcher.rs` / `agent_launcher_tests.rs`: launch selected agents in native PTY tabs, register live sidebar entries, and apply Codex/Claude runtime wiring.
