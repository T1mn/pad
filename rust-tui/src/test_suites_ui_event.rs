...
fn event_modes_suite() {
    run_cases!(
        ...
        crate::event::modes::settings::tests::profile::profile_full_access_and_unattended_toggles_persist,
        crate::event::modes::settings::tests::profile::profile_permission_mode_cycles_and_persists,
...
fn ui_panel_list_suite() {
    run_cases!(
        ...
        crate::ui::panel_list::tests::width::manual_width_is_used_exactly_and_can_shrink_auto_width,
