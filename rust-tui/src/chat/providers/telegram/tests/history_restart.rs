...
pub(crate) fn recent_history_message_shows_only_latest_three_turns() {
    let turns = vec![
        PreviewTurn {
...
pub(crate) fn recent_history_turns_prefers_latest_three_cached_turns() {
...
pub(crate) fn recent_history_turns_reads_codex_rollout_from_db_by_workdir() {
...
pub(crate) fn restart_shell_command_drops_telegram_bot_and_keeps_debug_flag() {
...
pub(crate) fn restart_shell_command_uses_release_profile_when_binary_is_release() {
    let command = build_pad_restart_shell_command(
