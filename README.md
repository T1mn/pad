...
- Press `F11` for PAD Terminal commands; it also focuses a visible terminal workspace when the sidebar is focused. `Ctrl+Space` is the portable fallback when the operating system captures the function key.
