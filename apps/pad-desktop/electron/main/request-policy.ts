...
const allowedFields: Record<DesktopAction, readonly string[]> = {
  ...
  read_session: ['task_id', 'limit'],
  rename_session: ['task_id', 'name'],
  spawn_agent: ['source_task_id', 'task', 'name'],
  send_message: ['source_task_id', 'task_id', 'message'],
  followup_task: ['source_task_id', 'task_id', 'message'],
  wait_agent: ['source_task_id', 'task_id', 'timeout_seconds'],
  interrupt_agent: ['source_task_id', 'task_id'],
  list_agents: ['source_task_id', 'task_id'],
  start_task: ['task_id'],
  retry_task: ['task_id'],
  ...
  stop: ['task_id'],
  stop_task: ['task_id'],
  set_task: ['task_id', 'title', 'pinned', 'archived', 'unread'],
  set_profile: [
    'profile_id',
    'default_provider',
    'default_model',
